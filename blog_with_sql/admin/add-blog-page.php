...
<div class="content">
   ...
   $stmt = $db->prepare('INSERT INTO tbl_pages (pageTitle,pageSlug,pageDescrip,pageContent,pageKeywords) VALUES (:pageTitle, :pageSlug, :pageDescrip, :pageContent,:pageKeywords)') ;
