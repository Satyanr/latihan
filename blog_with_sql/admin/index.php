...
if(isset($_GET['delpost'])){ 
    ...
    $stmt = $db->prepare('DELETE FROM tbl_blog WHERE articleId = :articleId') ;
...
<?php 
    ...
    <?php
        try {
            ...
            $stmt = $db->query('SELECT articleId, articleTitle, articleDate FROM tbl_blog ORDER BY articleId DESC');
