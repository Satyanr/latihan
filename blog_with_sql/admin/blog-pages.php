...
if(isset($_GET['delpost'])){ 
    ...
    $stmt = $db->prepare('DELETE FROM tbl_pages WHERE pageId = :pageId') ;
...
<?php 
    ...
    <?php
        try {
            ...
            $stmt = $db->query('SELECT pageId,pageTitle,pageDescrip,pageContent,pageKeywords FROM tbl_pages ORDER BY pageId DESC');
