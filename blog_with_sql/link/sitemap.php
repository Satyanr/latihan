...
$pages = $db->query('SELECT pageSlug FROM tbl_pages ORDER BY pageId ASC');
$article = $db->query('SELECT articleSlug FROM tbl_blog ORDER BY articleId ASC');
$category = $db->query('SELECT categorySlug FROM tbl_category ORDER BY categoryId ASC');
$tag= $db->query('SELECT articleTags FROM tbl_blog ORDER BY articleId ASC');
               

//define your base URLs 
//Main URL 
$base_url = "http://localhost/latihan/blog_with_sql/";
//Page base URL 
$page_base_url = "http://localhost/latihan/blog_with_sql/page/";
//Category base URL
$category_base_url = "http://localhost/latihan/blog_with_sql/category/";
//tag base URL
$tag_base_url = "http://localhost/latihan/blog_with_sql/tag/";
