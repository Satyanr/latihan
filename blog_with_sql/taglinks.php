    ...
    <p>Articles in tag:- <?php echo htmlspecialchars($_GET['id']);?></p>
        ...
        <?php   
            try {
                ...
                $stmt = $db->prepare('SELECT articleId, articleTitle, articleSlug, articleDescrip, articleDate, articleTags FROM tbl_blog WHERE articleTags like :articleTags ORDER BY articleId DESC');
